(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent='.homeHeader[data-profile-only-header="1"]{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:16px!important}.headerProfileButton{appearance:none;width:38px;height:38px;min-width:38px;padding:0;border:1px solid rgba(255,255,255,.28);border-radius:50%;background:transparent;color:inherit;display:grid;place-items:center;cursor:pointer}.headerProfileButton svg{width:24px;height:24px;fill:none;stroke:currentColor;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}.headerProfileButton:hover{background:rgba(255,255,255,.14)}#desktopProfileMenu{position:fixed;z-index:1300;width:170px;padding:4px;background:var(--profile-menu-bg,#fff);border:1px solid var(--profile-menu-border,#dfe3e8);border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.18);color:var(--profile-menu-text,#202124)}#desktopProfileMenu[data-anchor="header"]{right:12px;top:58px;left:auto}#desktopProfileMenu[data-anchor="rail"]{left:66px;top:62px;right:auto}#desktopProfileMenu button{width:100%;min-height:38px;padding:0 10px;border:0;border-radius:4px;background:transparent;color:var(--profile-menu-text,#202124);display:flex;align-items:center;text-align:left;font:inherit;font-size:13px;cursor:pointer}#desktopProfileMenu button:hover,#desktopProfileMenu button:focus-visible{background:var(--profile-menu-hover,#f1f3f5);outline:none}@media(max-width:899px){.homeHeader[data-profile-only-header="1"],#appGlobalHeader.globalAppHeader{display:flex!important;align-items:center!important;justify-content:space-between!important}.homeHeader[data-profile-only-header="1"] .headerProfileButton{color:var(--profile-header-text,#202124);border-color:var(--profile-menu-border,#dfe3e8)}.homeHeader[data-profile-only-header="1"] .headerProfileButton:hover{background:var(--profile-menu-hover,#f1f3f5)}#desktopProfileMenu{right:12px!important;top:64px!important;left:auto!important;width:min(170px,calc(100vw - 24px))}}html[data-theme="light"]{--profile-menu-bg:#fff;--profile-menu-text:#202124;--profile-menu-border:#dfe3e8;--profile-menu-hover:#f1f3f5;--profile-header-text:#202124}html[data-theme="dark"]{--profile-menu-bg:#161a23;--profile-menu-text:#f1f2f6;--profile-menu-border:#384152;--profile-menu-hover:#222936;--profile-header-text:#f5f7fb}';
