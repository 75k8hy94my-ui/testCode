...
const pages = ['index.html', 'sync.html', 'home.html', 'profile.html', 'manga.html', 'video.html', 'reader.html', 'video-player.html'];
const standalone = [
  ...
  'home-profile-spa.js', 'media-access-gate.js', 'profile-menu.js', 'shelf-search.js',
