...
const pages = ['index.html', 'sync.html', 'home.html', 'reader.html', 'local-reader.html', 'links.html', 'study.html', 'index-search.html', 'hyakusen.html', 'statutes.html'];
const standalone = [
  ...
  'status-message.js', 'statute-data.js', 'statutes-page.js', 'study-data.js', 'study-arguments.js', 'study-sync.js', 'study-quiz.js', 'study-audio.js', 'study-ai.js',
