...
const standalone = [
  ...
  'encrypted-asset-storage.js', 'encrypted-asset-sync.js',
  'image-transfer-settings.js', 'image-transfer-ledger.js', 'image-remote-access.js',
  'encrypted-asset-reader.js',
  'encrypted-asset-item.js',
