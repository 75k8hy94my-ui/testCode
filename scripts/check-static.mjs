...
const standalone = [
  ...
  'home-profile-spa.js', 'mobile-bottom-nav.js', 'manga-sandbox.js', 'media-access-gate.js', 'profile-menu.js', 'image-transfer-settings.js', 'image-transfer-ledger.js', 'image-remote-access.js', 'image-transfer-settings-ui.js', 'shelf-search.js',
