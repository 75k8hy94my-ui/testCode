...
function renderProfile(){
  ...
  target.innerHTML=`<section class="profileContent"><p id="homeSyncStatus" class="syncStatus profileToastStatus" aria-live="polite"></p><h2>プロフィール設定</h2><dl class="profileMeta"><div><dt>ログイン中</dt><dd id="profileEmail"></dd></div></dl><section class="profileCard profileSecurityCard"><h3>認証方法</h3><div class="profileSecurityFields"><label class="profileField">現在のパスフレーズ<input id="profileCurrentPassphrase" type="password" autocomplete="current-password"></label><div class="profileSecurityActions"><button class="glassBtn profileAction" id="profilePasskeyRegisterBtn" type="button" data-profile-security-action>パスキーを設定</button><button class="glassBtn profileDanger" id="profilePasskeyRemoveBtn" type="button" data-profile-security-action>登録済みパスキーを解除</button></div><label class="profileField">新しいパスフレーズ<input id="profileNewPassphrase" type="password" autocomplete="new-password"></label><label class="profileField">新しいパスフレーズ（確認）<input id="profileNewPassphraseConfirm" type="password" autocomplete="new-password"></label><button class="glassBtn profileAction" id="profilePassphraseResetBtn" type="button" data-profile-security-action>パスフレーズを再設定</button></div><p id="profileSecurityStatus" class="profileSecurityStatus" role="status" aria-live="polite"></p></section><section class="profileCard"><h3>VPN診断</h3><div id="profileNonVpnIps"></div></section><section class="profileCard"><h3>表示</h3><label class="profileThemeRow"><span>ライトテーマ</span><span class="iosSwitch"><input id="profileThemeLight" type="checkbox" role="switch" aria-label="ライトテーマ"><span class="iosSwitchTrack" aria-hidden="true"></span></span></label></section><section class="profileCard"><h3>セッション</h3><button class="glassBtn profileDanger" id="profileLogoutBtn" type="button">ログアウト</button></section></section>`;
